...
switch project_name
    ...
    case project_name                      % Update with your project name
        ...
        HRVparams.readdata = project_name; % (Optional) Specify name for data input folder
        HRVparams.writedata = project_name;% (Optional) Specify name for data output folder
